...
const JOUEURS = [
  { id: 1, nom: "Thomas R.", serie: "15/1", sexe: "H", club: "TC Rennes", distance: "1.2 km", dispo: "Week-end", avatar: "TR", couleur: "#1E5FAF" },
  { id: 2, nom: "Sophie M.", serie: "15", sexe: "F", club: "Rennes Ill.", distance: "2.4 km", dispo: "Soir semaine", avatar: "SM", couleur: "#C75D3F" },
  { id: 3, nom: "Lucas B.", serie: "15/2", sexe: "H", club: "TC Cesson", distance: "3.1 km", dispo: "Matin", avatar: "LB", couleur: "#2D5016" },
  { id: 4, nom: "Camille D.", serie: "30", sexe: "F", club: "TC Rennes", distance: "0.8 km", dispo: "Week-end", avatar: "CD", couleur: "#1E5FAF" },
  { id: 5, nom: "Maxime L.", serie: "4/6", sexe: "H", club: "Rennes Ill.", distance: "4.2 km", dispo: "Flexible", avatar: "ML", couleur: "#C75D3F" },
  { id: 6, nom: "Julie P.", serie: "15/3", sexe: "F", club: "TC Cesson", distance: "2.9 km", dispo: "Soir semaine", avatar: "JP", couleur: "#2D5016" },
];
        ...
        <div className="flex items-center justify-between mb-3">
          ...
          >
            ...
            {(sexeFiltre !== "Tous" || serieFiltre !== "Toutes") && (
              <span className="w-2 h-2 rounded-full ml-1" style={{ backgroundColor: "#C75D3F" }} />
            )}
          </button>
        </div>
        {showFiltres && (
            ...
            <div className="mb-3">
              ...
              <div className="flex gap-2">
                {["Tous", "H", "F"].map((s) => (
                  <button
                    key={s}
                    onClick={() => setSexeFiltre(s)}
                    className="px-4 py-1.5 rounded-full text-sm font-medium transition-all"
                    style={{
                      backgroundColor: sexeFiltre === s ? "#1E5FAF" : "#F3F4F6",
                      color: sexeFiltre === s ? "white" : "#374151",
                    }}
                  >
            ...
            <div>
              ...
              <div className="flex gap-2 flex-wrap">
                {SERIES.map((s) => (
                  <button
                    key={s}
                    onClick={() => setSerieFiltre(s)}
                    className="px-3 py-1.5 rounded-full text-sm font-medium transition-all"
                    style={{
                      backgroundColor: serieFiltre === s ? "#1E5FAF" : "#F3F4F6",
                      color: serieFiltre === s ? "white" : "#374151",
                    }}
                  >
                    {s}
                  </button>
          ...
          {joueursFiltres.map((joueur) => (
            <div key={joueur.id} className="bg-white rounded-2xl p-4 shadow-sm border border-gray-100 flex items-center gap-4">
              <div
                ...
                style={{ backgroundColor: joueur.couleur }}
              >
                {joueur.avatar}
              </div>
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs px-2 py-0.5 rounded-full font-medium" style={{ backgroundColor: "#EFF6FF", color: "#1E5FAF" }}>
                    {joueur.serie}
                  </span>
                </div>
              ...
              <button
                onClick={() => envoyerDemande(joueur.id)}
                disabled={demandeEnvoyee.includes(joueur.id)}
                className="px-3 py-2 rounded-xl text-sm font-bold transition-all flex-shrink-0"
                style={{
                  backgroundColor: demandeEnvoyee.includes(joueur.id) ? "#F3F4F6" : "#1E5FAF",
                  color: demandeEnvoyee.includes(joueur.id) ? "#9CA3AF" : "white",
                }}
              >
